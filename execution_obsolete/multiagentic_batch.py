    ...
    def _process_batch(self, batch_questions: List[Dict[str, Any]], 
        ...
        for loop in range(MAX_FEEDBACK_LOOPS):
            ...
            if loop == 0:
                ...
                if len(outputs) == 0 and training_context:
                    print("    🔁 Empty output detected; retrying once with reduced training context (2000 chars)...")
                    reduced_ctx = training_context[:2000]
                    outputs = self.transformer.generate_batch(
