...
class AsyncMultiAgentPipeline:
    ...
    async def _process_file_async(self, gen_file: Path, training_context: str):
        ...
        # Process batches SEQUENTIALLY to avoid rate limit overload
        print(f"\n🚀 Starting SEQUENTIAL processing of {num_batches} batches (to avoid 429 errors)...")
        ...
        for batch_idx in range(num_batches):
            ...
            print(f"\n📦 Processing batch {batch_idx + 1}/{num_batches} sequentially...")
